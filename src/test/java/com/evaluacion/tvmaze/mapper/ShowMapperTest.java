...
class ShowMapperTest {
    ...
    void usesNetworkNameWhenPresent() {
        ...
        List<CommentResponse> comments = List.of(new CommentResponse("Excelente", 5));

        ShowSummaryResponse result = mapper.toSummary(show, comments);
    ...
    void fallsBackToWebChannelWhenNetworkIsMissing() {
        ...
        assertThat(mapper.toSummary(show, List.of()).channel()).isEqualTo("Netflix");
    }
    ...
    void returnsNullChannelAndEmptyGenresWhenDataIsMissing() {
        ...
        ShowSummaryResponse result = mapper.toSummary(show, List.of());
